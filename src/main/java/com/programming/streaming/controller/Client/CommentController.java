...
public class CommentController {
     ...
     * public ResponseEntity updateComment(@PathVariable("id") String
     * id, @RequestBody Comment comment) {
     * try {
     ...
     * public ResponseEntity increaseLikes(@PathVariable("id") String
     * id, @RequestParam int increment) {
     * try {
     * Comment commentFromDb = commentRepository.findById(id)
     * .orElseThrow(() -> new Exception("Comment not found"));
     ...
     * public ResponseEntity increaseDislikes(@PathVariable("id") String
     * id, @RequestParam int increment) {
     * try {
     * Comment commentFromDb = commentRepository.findById(id)
     * .orElseThrow(() -> new Exception("Comment not found"));
     ...
     * public ResponseEntity decreaseLikes(@PathVariable("id") String
     * id, @RequestParam int decrement) {
     * try {
     * Comment commentFromDb = commentRepository.findById(id)
     * .orElseThrow(() -> new Exception("Comment not found"));
     ...
     * public ResponseEntity decreaseDislikes(@PathVariable("id") String
     * id, @RequestParam int decrement) {
     * try {
     * Comment commentFromDb = commentRepository.findById(id)
     * .orElseThrow(() -> new Exception("Comment not found"));
