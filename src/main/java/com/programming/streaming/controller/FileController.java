...
import com.programming.streaming.service.FileService;
...
public class FileController {
    ...
    public ResponseEntity<?> upload(@RequestParam("file") MultipartFile file, @RequestParam("title") String title)
            // , @RequestBody LoadFile loadfile
            throws IOException {
        // String title = "title";
        // String description = "des";
        return new ResponseEntity<>(fileService.addFile(file, title), HttpStatus.OK);
    }
